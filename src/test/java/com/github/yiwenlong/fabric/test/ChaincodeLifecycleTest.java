...
public class ChaincodeLifecycleTest {
    ...
    @Test
    public void testInstallChaincode() throws Exception {
          ...
          Collection<LifecycleInstallChaincodeProposalResponse> responses = client.sendLifecycleInstallChaincodeRequest(request, SingleOrgNetwork.Org1.getPeersAdmin(client));
    ...
    @Test
    public void testQueryInstalledChaincode() throws Exception {
        LifecycleQueryInstalledChaincodesRequest queryRequest = client.newLifecycleQueryInstalledChaincodesRequest();
        Collection<LifecycleQueryInstalledChaincodesProposalResponse> responses = client.sendLifecycleQueryInstalledChaincodes(queryRequest, SingleOrgNetwork.Org1.getPeersAdmin(client));
        ...
        client.newLifecycleQueryInstalledChaincodeRequest();
    }

    @Test
    public void testApproveChaincode() throws Exception {
        ...
        peers.add(peer0);
        Collection<LifecycleApproveChaincodeDefinitionForMyOrgProposalResponse>  response = mychannel.sendLifecycleApproveChaincodeDefinitionForMyOrgProposal(request, peers);
    ...
    @Test
    public void testQueyApproveChaincode() throws Exception {
        Collection<Peer> peers = new ArrayList<>();
        peers.add(peer0);
        ...
        request.setSequence(1);
        request.setChaincodeVersion("1");
        Collection<LifecycleCheckCommitReadinessProposalResponse> responses  = mychannel.sendLifecycleCheckCommitReadinessRequest(request, peers);
        responses.forEach(response -> {
            try {
    ...
    @Test
    public void testCommitChaincode() throws Exception {
        ...
        Collection<Peer> peers = new ArrayList<>();
        peers.add(peer0);
        Collection<LifecycleCommitChaincodeDefinitionProposalResponse> responses = mychannel.sendLifecycleCommitChaincodeDefinitionProposal(request, peers);
    ...
    @Test
    public void testChaincodeDefinition() throws Exception {
        LifecycleQueryChaincodeDefinitionsRequest request = client.newLifecycleQueryChaincodeDefinitionsRequest();
        Collection<Peer> peers = new ArrayList<>();
        peers.add(peer0);
        Collection<LifecycleQueryChaincodeDefinitionsProposalResponse> reponses = mychannel.lifecycleQueryChaincodeDefinitions(request, peers);
